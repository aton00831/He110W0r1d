...
object Aggregations extends App {
  ...
  // approximate count (for really big dataframe, a quick solution)
  ...
  // aggregation and grouping are wide transformation (map, filter are narrow transformation)
  // shuffle = data being move in between partition (Big Performance Impact)
}
